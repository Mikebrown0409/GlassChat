...
const AI_AVATARS = [
  { id: 'sage', name: 'Sage', emoji: '🧙‍♂️', color: 'from-emerald-400 to-teal-500' },
  { id: 'nova', name: 'Nova', emoji: '⭐', color: 'from-purple-400 to-pink-500' },
  { id: 'iris', name: 'Iris', emoji: '👁️', color: 'from-blue-400 to-indigo-500' },
...
export function ChatContainer({ className }: ChatContainerProps) {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      content: "Hello! I'm here to help you with anything you need. What would you like to explore today?",
      isUser: false,
      timestamp: new Date(),
    }
  ]);
  ...
  const [aiPersona, setAiPersona] = useState(AI_AVATARS[0]);
        ...
        <AnimatePresence>
          {showPersonalization && (
            <motion.div
              ...
              className="max-w-4xl mx-auto mt-4 p-4 rounded-xl bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm"
            >
              ...
              >
                ...
                <div className={clsx(
                  ...
                  <motion.div
                    ...
                    className={clsx(
                      "p-4 rounded-2xl backdrop-blur-sm border shadow-sm",
                      message.isUser
                        ? theme === 'dark'
          ...
          {isTyping && (
            ...
            >
              ...
              <div className="flex-1">
                <div className={clsx(
                  "p-4 rounded-2xl backdrop-blur-sm border inline-block",
                  theme === 'dark'
                ...
                <motion.button
                  ...
                  className={clsx(
                    ...
                    activeQuickReply === reply
                      ? "bg-gradient-to-r from-orange-400 to-red-500 text-white border-transparent shadow-lg"
                      : theme === 'dark'
            ...
            <div className="relative">
              <textarea
                ...
                className={clsx(
                  ...
                  "min-h-[56px] max-h-32 outline-none"
                )}
                rows={1}
              />
